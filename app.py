...
app = Flask(__name__)
# Configure Flask to look for templates in the current directory AND 'templates' folder
app.jinja_loader = ChoiceLoader([
    FileSystemLoader(app.root_path),
    FileSystemLoader(os.path.join(app.root_path, 'templates'))
])

# Data: Courses with Roadmaps
# Data: Courses with Roadmaps
courses_data = [
    {
        'id': 'python-ai',
...
@app.route('/')
def home():
    # Pass first 3 courses as popular
    return render_template('index.html', courses=courses_data[:3])
